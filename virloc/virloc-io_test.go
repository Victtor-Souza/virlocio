...
func TestSerialize(t *testing.T) {
	...
	testCases := []TestCase{
		{
			test:     "MESSAGE RUV03",
			message:  ">RUV03150,NT003,030822184257,65,69584,120455002,2312,86,10,29,44895330,0,40,36,0,0,0,0,0,0,0,0,0;ID=0083;#0030;*54<",
			expected: nil,
		},
		{test: "Message RUV01",
			message:  ">RUV01100,NT003,240622184546-1926542-046895630000009FFDE0000,04221376,00000,00000,00000,1111111111,2222222222,03333,00444,55555,00100,0,0,4G:1,1644991399;ID=0081;#8012;*18<",
			expected: nil,
		},
		{test: "Message QTT",
